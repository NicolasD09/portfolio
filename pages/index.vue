      ...
      >
        <div class="relative mx-auto w-auto max-x-2xl">
          <div class="bg-white w-auto mx-auto px-12 pb-6 rounded-lg relative">
            ...
            <p class="text-2xl">Le site est en cours de construction !</p>
            <p class="text-2xl">Merci pour votre patience !</p>
            <hr class="border-black my-4" />
            <h1 class="text-5xl">Welcome !</h1>
            <p class="text-2xl">The website is still under construction !</p>
            <p class="text-2xl">Thanks for your patience !</p>
          </div>
        </div>
      </div>
    </transition>
