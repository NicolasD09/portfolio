          ...
          <div class="mx-auto py-6 sm:p-8">
            ...
            >
              <div>
                ...
                <div v-if="project.long_description">
                  <div>{{ project.long_description.fr }}</div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row">
                  ...
                  <Button class="mt-4 sm:mt-12" type="secondary" to="/projets"
                    >Retourner aux projets</Button
                  >
                </div>
              </div>
              <div class="flex flex-row justify-center mt-8 lg:mt-0">
                ...
                >
                  <div class="project__image__container pr-4">
                    <img
                      class="mx-auto"
                      :src="`${project.image.asset.url}?fm=webp`"
